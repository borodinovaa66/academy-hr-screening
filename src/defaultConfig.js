...
const defaultConfig = {
  version: 14,
  vacancyCode: "smm",
  publicTitle: "Специалист по соцсетям",
  adminTitle: "Соцсети",
  title: "Анкета специалиста по соцсетям",
  ...
  ui: {
    welcomeLabel: "Специалист по соцсетям",
    welcomeTitle: "Привет! Давайте познакомимся",
    welcomeLead: "Мы рады, что вы заинтересовались вакансией специалиста по соцсетям. Ответьте на несколько вопросов, чтобы мы быстрее поняли ваш опыт, подход к работе и соответствие роли.",
    ...
    testSublead: "Это не большое тестовое на полдня, а короткое практическое задание, чтобы мы увидели ваш подход к контенту, аналитике и гипотезам роста.",
