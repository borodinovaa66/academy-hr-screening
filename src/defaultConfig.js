...
const smmInterview = {
  title: "Интервью специалиста по соцсетям",
  ...
  intro: [
    "Цель интервью - проверить не только опыт ведения соцсетей, а профессиональное мышление: экспертный контент, аналитику, воронку, самостоятельность и культурное соответствие.",
  ...
  projectiveBlocks: [
    {
      ...
      questions: [
        { id: "role_1", text: "Почему, на ваш взгляд, люди выбирают работу специалиста по соцсетям в экспертных или образовательных проектах?", goal: "Мотивация и понимание роли" },
        { id: "role_2", text: "Почему одни специалисты по соцсетям быстро выгорают, а другие долго остаются эффективными?", goal: "Осознанность, устойчивость, ожидания" },
        { id: "role_3", text: "Что обычно отличает сильного специалиста по соцсетям от человека, который просто публикует готовые посты?", goal: "Понимание широты роли" }
      ]
    },
    {
      id: "responsibility",
      ...
      questions: [
        ...
        { id: "resp_2", text: "Как обычно ведет себя ответственный специалист по соцсетям, если понимает, что публикация или запуск под риском?", goal: "Проактивность и работа с рисками" },
    ...
    },
    {
      ...
      questions: [
        ...
        { id: "analytics_2", text: "Почему некоторые специалисты по соцсетям избегают регулярной аналитики?", goal: "Отношение к цифрам" },
        { id: "analytics_3", text: "Когда специалист по соцсетям должен спорить с утвержденным контент-планом и предлагать изменения?", goal: "Самостоятельность и аргументация" }
      ]
    },
    {
      id: "expertContent",
      ...
      questions: [
        ...
        { id: "expert_2", text: "Как специалист по соцсетям может получать от эксперта качественный материал без конфликта и давления?", goal: "Коммуникация и координация" },
    ...
    },
    {
      ...
      questions: [
        ...
        { id: "culture_2", text: "Какая обратная связь помогает специалисту по соцсетям расти, а какая разрушает работу?", goal: "Коммуникационный стиль" }
      ]
    }
  ],
  cases: [
    ...
    },
    {
      ...
      situation: "Эксперт и руководитель задерживают правки, публикации выходят поздно, команда начинает обвинять специалиста по соцсетям.",
  ...
  scorecard: [
    ...
    { id: "businessOrientation", title: "Ориентация на бизнес-результат", description: "Понимает, что работа с соцсетями должна помогать воронке, а не только выпускать контент.", sources: "Все кейсы, ответы про метрики и заявки" }
  ],
...
const defaultConfig = {
  ...
  testAssignment: {
    ...
    title: "Практическое задание для специалиста по соцсетям",
    ...
    instruction: [
      ...
      "Не нужно делать дизайн-макеты, полноценную стратегию или бесплатный аудит. Нам нужен короткий документ на 1 страницу: как вы мыслите и на что обращаете внимание.",
      "Коротко опишите первое впечатление: что понятно сразу, а что вызывает вопросы.",
      "Найдите 3 сильные стороны профиля с точки зрения продвижения в соцсетях.",
      "Найдите 3 зоны роста: упаковка, контент, визуал, истории, закрепленные материалы, призыв к действию, путь к заявке.",
      "Предложите 5 конкретных гипотез улучшения на ближайшие 2 недели.",
      "Предложите 3-5 контент-единиц: пост, короткое вертикальное видео, истории, адаптация для канала в мессенджере или другой формат.",
    ...
    evaluationCriteria: [
      ...
      { id: "funnelThinking", title: "Мышление воронкой", max: 20, description: "Связывает контент, призыв к действию, путь пользователя и заявку." },
  ...
  ui: {
    ...
    guideAlt: "Помощник анкеты по соцсетям",
    ...
    testSublead: "Это не большое тестовое на полдня и не бесплатная работа. Нужен короткий документ, чтобы мы увидели ваш подход к контенту, аналитике и гипотезам роста.",
...
const projectManagerConfig = {
  ...
  testAssignment: {
    ...
    instruction: [
      ...
      "Не нужно делать полноценную стратегию или объемный документ. Нам нужен короткий рабочий план: как вы структурируете запуск и риски.",
  ...
  ui: {
    ...
    testSublead: "Задание короткое: не нужно делать бесплатную работу или объемную стратегию. Нужно показать, как вы ведете запуск, сроки, риски, подрядчиков и отчетность.",
